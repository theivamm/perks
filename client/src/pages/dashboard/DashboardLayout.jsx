              ...
              {menuOpen && (
                <div className="animate-fade-up absolute right-0 top-full z-50 mt-3 w-72 overflow-hidden rounded-3xl border border-line bg-surface shadow-2xl">
                  <div className="flex items-center gap-3 px-4 pb-3 pt-4">
                    ...
                    <div className="min-w-0">
                      <p className="truncate font-heading text-base font-bold text-ink">{user.name}</p>
                  ...
                  <div className="border-t border-line p-2">
                    <button className="group flex w-full items-center gap-3 rounded-2xl px-2.5 py-2 text-left text-sm font-semibold text-ink transition-colors hover:bg-surface-alt" onClick={go(t('/'))}>
                    ...
                    <button className="group flex w-full items-center gap-3 rounded-2xl px-2.5 py-2 text-left text-sm font-semibold text-ink transition-colors hover:bg-surface-alt" onClick={go(t('/dashboard/escanear'))}>
                      <span className="flex h-8 w-8 shrink-0 items-center justify-center rounded-xl bg-surface-alt text-ink-muted transition-colors group-hover:bg-primary-softer group-hover:text-primary-strong">
                        <ScanLine size={15} />
                      </span>
                      Escanear QR
                    </button>
                    <button className="group flex w-full items-center gap-3 rounded-2xl px-2.5 py-2 text-left text-sm font-semibold text-ink transition-colors hover:bg-surface-alt" onClick={go(t('/dashboard/configuracion'))}>
                      <span className="flex h-8 w-8 shrink-0 items-center justify-center rounded-xl bg-surface-alt text-ink-muted transition-colors group-hover:bg-primary-softer group-hover:text-primary-strong">
                  ...
                  <div className="border-t border-line p-2">
                    <button className="flex w-full items-center gap-3 rounded-2xl px-2.5 py-2 text-left text-sm font-semibold text-red-500 transition-colors hover:bg-red-500/10" onClick={doLogout}>
